...
import { crearAction, toggleCompletadoAction, editarAction, eliminarAction, toggleAllAction } from './nota.actions';
...
const _notaReducer = createReducer(
    ...
    on(toggleAllAction, (state, { completado }) => state.map(nota => {
        return {
            ...nota,
